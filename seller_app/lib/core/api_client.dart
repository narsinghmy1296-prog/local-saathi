...
class ApiClient {
  ...
  /// NEW for Seller App — POST /uploads/product-image needs multipart/
  /// form-data, which the JSON-only helpers above don't support. Kept as
  /// a single extra method here rather than a parallel client, so every
  /// other service still shares one 401/error-handling path.
